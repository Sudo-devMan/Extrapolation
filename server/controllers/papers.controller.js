...
export const getPapers = async(req, res) => {
  try {
    ...
    return res.status(200).json({success: true, message: 'Papers fetched successfully', papers })
  } catch (err) {
    console.error(err)
...
export const onePaper = async(req, res) => {
  ...
  try {
    ...
    return res.status(200).json({ success: true, message: 'Paper fetched successfully', paper })
  } catch (err) {
    console.error(err)
    res.status(500).json({ success: false, message: err.message })
  }
...
export const uploadPaper = async(req, res) => {
  ...
  try {
    ...
    return res.status(201).json({ success: true, message: 'Uploaded successfully', paper: completePaper })
  } catch (err) {
    console.error(err)
    res.status(500).json({success: false, message: err.message})
  }
...
export const editPaper = async(req, res) => {
  ...
  try { 
    ...
    return res.status(200).json({success: true, message: 'Upload was edited successfully', paper: edited })
  } catch (err) {
    console.error(err)
    res.status(500).json({ success: false, message: err.message })
  }
